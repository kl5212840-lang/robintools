...
export const metadata: Metadata = {
  title: "知识库 | AI Tools Guide",
  description: "AI 编程工具的使用记录、配置参考与实践总结",
};
...
export default function ArticlesPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16">
      ...
      <ArticleList articles={articles.filter(a => a.slug !== "ai-pair-workflow").map(a => ({ slug: a.slug, title: a.title, summary: a.summary, date: a.date, category: a.category, tags: a.tags }))} />
    </div>
  );
}
